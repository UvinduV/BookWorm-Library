...
public class BorrowedBookFormController implements Initializable {
    @FXML
    ...
    void btnBooksOnAction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(this.getClass().getResource("/view/UsersBook.fxml"));
    ...
    void btnBorrowedOnAction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(this.getClass().getResource("/view/BorrowedBookForm.fxml"));
    ...
    void btnPasswordOnAction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(this.getClass().getResource("/view/ProfileForm.fxml"));
